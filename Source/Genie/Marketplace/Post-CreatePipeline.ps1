...
# Create-Pipeline -Organization "ajaymaile" -projectName "sample-test" -pat "w67eqcg25k2adnazlwzmxvphvppvj7lmf7pit7rxrksgezg5nxhq" -pipelineName "demoPiepline" -repoName "sampl-test" -branchName "Demo" -localCodeDirectory $localCodeDirectory -path $path 