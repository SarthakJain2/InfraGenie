...
$settings = .\scripts\Get-AppSettings.ps1 -Domain $domain -Environment $Environment
...
if ( $SubscriptionId -eq "") {
    ...
    [string] $subscriptionName = .\scripts\Get-SubscriptionName.ps1 -Domain $domain -Environment $Environment
