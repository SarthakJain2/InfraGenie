...
$files = @("$root/Source/Golden/.tags/$Domain/$Domain.json", "$root/Source/Golden/.tags/$Domain/$Domain-$Environment.json")
if ( $ProjectName -ne '') {
    $files += @("$root/Source/Golden/.tags/$Domain/$Domain-$ProjectName.json", "$root/Source/Golden/.tags/$Domain/$Domain-$ProjectName-$Environment.json")
}
