$jsonFilePath = "D:\Marketplace\Nuget Publish\parameter.json" 
...
Get-ArtifactsFeedPackages -Organization $organization -Project $project -FeedId $feedId -PAT $pat

Write-Host "https://pkgs.dev.azure.com/$Organization/$projectName/_apis/packaging/feeds/$feedName/nuget/packages/$packageName/Versions/$packageVersion/content?api-version=7.0-preview.1"
